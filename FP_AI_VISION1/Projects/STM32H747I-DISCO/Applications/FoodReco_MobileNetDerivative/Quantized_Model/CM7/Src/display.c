...
int DisplayWelcomeScreen(void)
{
  ...
  BSP_LCD_DisplayStringAt(0, LINE(12), (uint8_t *)WELCOME_MSG_3, CENTER_MODE);
  ...
  for (int i = 0; i < 18; i++)
  {
    BSP_LCD_DrawBitmap(LCD_RES_WIDTH / 2 - 64, LCD_RES_HEIGHT/2 + 90, (uint8_t *)Logos_128x128_bmp[i]);
    HAL_Delay(100);
    LCD_Refresh();
