...
#if MEMORY_SCHEME ==  FULL_EXTERNAL
 #define AI_FP_GLOBAL_BUFFER_SIZE  (CAM_FRAME_BUFFER_SIZE + IMG_RGB24_BUFFER_SIZE + IMG_RGB24_SCALED_BUFFER_SIZE + AI_INPUT_BUFFER_SIZE + AI_ACTIVATION_BUFFER_SIZE)
#elif MEMORY_SCHEME == SPLIT_INT_EXT
 #define AI_FP_GLOBAL_BUFFER_SIZE  (CAM_FRAME_BUFFER_SIZE + IMG_RGB24_BUFFER_SIZE + IMG_RGB24_SCALED_BUFFER_SIZE + AI_INPUT_BUFFER_SIZE)
#else
  #error Please check definition of MEMORY_SCHEME define
#endif
