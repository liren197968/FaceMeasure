...
uint8_t *lcd_frame_write_buff = lcd_display_global_memory + LCD_FRAME_BUFFER_SIZE;
...
int DisplayWelcomeScreen(void)
{
  ...
  BSP_LCD_DisplayStringAt(0, LINE(4), (uint8_t *)"VISION1 Function Pack", CENTER_MODE);
  BSP_LCD_DisplayStringAt(0, LINE(5), (uint8_t *)"V1.1.0", CENTER_MODE);
  BSP_LCD_DisplayStringAt(0, LINE(8), (uint8_t *)WELCOME_MSG_0, CENTER_MODE);
  BSP_LCD_DisplayStringAt(0, LINE(9), (uint8_t *)WELCOME_MSG_2, CENTER_MODE);
  BSP_LCD_DisplayStringAt(0, LINE(10), (uint8_t *)WELCOME_MSG_1, CENTER_MODE);
  BSP_LCD_DisplayStringAt(0, LINE(11), (uint8_t *)WELCOME_MSG_4, CENTER_MODE);
  BSP_LCD_DisplayStringAt(0, LINE(12), (uint8_t *)WELCOME_MSG_5, CENTER_MODE);
  BSP_LCD_DisplayStringAt(0, LINE(13), (uint8_t *)WELCOME_MSG_3, CENTER_MODE);
  ...
  for (int i = 0; i < 18; i++)
  {
    BSP_LCD_DrawBitmap(LCD_RES_WIDTH / 2 - 64, LCD_RES_HEIGHT/2 + 100, (uint8_t *)Logos_128x128_bmp[i]);
    HAL_Delay(100);
    LCD_Refresh();
